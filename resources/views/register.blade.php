<x-main-layout>
    ...
    <main class="m-8 mx-auto mt-8 w-3/4 ">
        <h1 class="text-2xl font-bold text-center mb-4 mx-auto">Register Form</h1>
        <form class="flex justify-center mx-auto flex-col max-w-lg">
            ...
            <label for="register">Already have an account?
                <a href="/login" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Login
                    here</a>
            </label>
            <button type="submit"
